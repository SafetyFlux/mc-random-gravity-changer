...
execute if score value GravityTimer matches 0..9 if score value NextGravDirection matches 1 run bossbar set minecraft:rgctimer name [{"text":"Next Direction: ","color":"white"},{"text":"Up","color":"green"}]
execute if score value GravityTimer matches 0..9 if score value NextGravDirection matches 2 run bossbar set minecraft:rgctimer name [{"text":"Next Direction: ","color":"white"},{"text":"North","color":"green"}]
execute if score value GravityTimer matches 0..9 if score value NextGravDirection matches 3 run bossbar set minecraft:rgctimer name [{"text":"Next Direction: ","color":"white"},{"text":"South","color":"green"}]
execute if score value GravityTimer matches 0..9 if score value NextGravDirection matches 4 run bossbar set minecraft:rgctimer name [{"text":"Next Direction: ","color":"white"},{"text":"East","color":"green"}]
